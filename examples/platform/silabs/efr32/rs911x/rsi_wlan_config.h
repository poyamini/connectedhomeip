...
#if WIFI_ENABLE_SECURITY_MODE_WPA3_ONLY // WPA3 MODE:WPA3 SUPPORTED
...
#endif
#elif WIFI_ENABLE_SECURITY_MODE_WPA_MIXED // MIXED MODE:WPA AND WPA2 SUPPORTED
#ifdef RSI_M4_INTERFACE
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP EXT_FEAT_256K_MODE
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP EXT_FEAT_384K_MODE
#endif
#else // TRANSITION MODE:WPA2 AND WPA3 SUPPORTED
#ifdef RSI_M4_INTERFACE
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP (EXT_FEAT_256K_MODE | EXT_FEAT_IEEE_80211W)
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP (EXT_FEAT_320K_MODE | EXT_FEAT_IEEE_80211W)
#endif
#endif
...
#if WIFI_ENABLE_SECURITY_MODE_WPA3_ONLY // WPA3 ONLY:WPA3 ONLY SUPPOETED
#define RSI_JOIN_FEAT_BIT_MAP RSI_JOIN_FEAT_MFP_CAPABLE_REQUIRED
#else
#if WIFI_ENABLE_SECURITY_MODE_WPA3_TRANSITION // TRANSITION MODE:WPA2 AND WPA3 SUPPORTED
#define RSI_JOIN_FEAT_BIT_MAP RSI_JOIN_FEAT_MFP_CAPABLE_ONLY
#else // MIXED MODE:WPA AND WPA2 SUPPORTED
